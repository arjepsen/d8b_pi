...
using ButtonCallbackFunction = std::function<void(const int stripNumber, const ButtonType btnType, const ButtonAction btnAction, EventSource)>;

std::unordered_map<std::string, MessageInfo> buttonCallbacks{
    // ###### CHANNELSTRIP BUTTONS ##########

	// ch number, button function, callback-array.
